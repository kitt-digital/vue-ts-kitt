    ...
    docs: {
      description: {
        component: String(`
          ...
          <br>
          <br>
          Additional HTML attributes can be also added with the \`htmlAttributes\` object (<a href="https://www.w3schools.com/tAGS/tag_img.asp" target="_blank">possible attributes</a>).
        `)
          .replace(/\s+/g, ' ')
          .trim()
      }
